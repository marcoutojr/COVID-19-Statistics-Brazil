...
###############################################################################
file = 'Data\Data_02042020.csv' # Put the update CSV file here
date = '02_04_2020' # Update the data as well
...
for k in range(0, len(states)):
    if total_data['Region'][k] == 'Central':
        ...
        plt.annotate(total_data.index[k], (days_per_state[k], total_data.iloc[k, days_per_state[k] - 1]), 
                    textcoords = 'offset points', xytext=(5, -5), ha='right', fontsize = 12.5, weight = 'bold')
    ...
    if total_data['Region'][k] == 'South':
        ...
        plt.annotate(total_data.index[k], (days_per_state[k], total_data.iloc[k, days_per_state[k] - 1]), 
                    textcoords = 'offset points', xytext=(5, 0), ha='right', fontsize = 12.5, weight = 'bold')
...
#         ax3.annotate(txt2, (x[i], new_state.iloc[i]), color = 'b', textcoords = 'offset points', xytext=(0, 8), ha='center', fontsize = 11, weight = 'bold')
